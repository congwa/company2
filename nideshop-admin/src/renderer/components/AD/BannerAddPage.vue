    ...
    <div class="content-page">
        <div class="content-nav">
            <el-breadcrumb class="breadcrumb" separator="/">
                ...
                <el-breadcrumb-item>{{infoForm.id ? '编辑banner' : '添加banner'}}</el-breadcrumb-item>
            </el-breadcrumb>
                ...
                <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
                    ...
                    <el-form-item label="展示图" prop="image_url">
                        <el-upload class="image-uploader" name="image_url"
                            ...
                            <img v-if="infoForm.image_url" :src="api.rootUrl + infoForm.image_url" class="image-show">
        ...
        data() {
            return {
                ...
                infoRules: {
                  ...
                  image_url: [
                        { required: true, message: '请选择轮播展示图', trigger: 'blur' },
                    ],
                },
            }
        },
        methods: {
            ...
            onSubmitInfo() {
                this.$refs['infoForm'].validate((valid) => {
                    if (valid) {
                        this.axios.post('banner/add', this.infoForm).then((response) => {
