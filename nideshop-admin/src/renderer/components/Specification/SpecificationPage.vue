	...
	<div class="content-page">
		<div class="content-nav">
			...
			<div class="operation-nav">
				<router-link to="/dashboard/specification/add">
					<el-button type="primary" icon="plus">添加商品规格</el-button>
				</router-link>
			</div>
		</div>
		<div class="content-main">
			...
			<div class="form-table-box">
				<el-table :data="tableData" style="width: 100%" border stripe>
					...
					<el-table-column prop="sort_order" label="规格排序">
					</el-table-column>
...
export default {
	...
	methods: {
		...
		handleRowEdit(index, row) {
			this.$router.push({ name: 'specification_add', query: { id: row.id } })
		},
		...
		getList() {
			this.axios.get('specification/index').then((response) => {
