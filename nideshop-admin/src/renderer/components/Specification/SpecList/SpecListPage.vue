    ...
    <div class="content-page">
        <div class="content-nav">
            ...
            <div class="operation-nav">
                ...
                <el-button type="primary" @click="handleRowEdit" icon="plus">添加规格信息</el-button>
            </div>
        </div>
            ...
            <div class="form-table-box">
                <el-table :data="tableData" style="width: 100%" border stripe>
                    ...
                    <el-table-column label="操作" width="140">
                        <template scope="scope">
                            <el-button size="small" @click="handleRowEdit(scope.$index, scope.row)">添加</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      handleRowEdit(index, row) {
        this.$router.push({ name: 'specification_list_add', query: { id: this.goods_id } })
      },
      handleRowDelete(index, row) {
        ...
        this.$confirm('确定要删除?', '提示', {
          ...
          this.axios.post('specification/goodsSpecDelete', { id: row.id }).then((response) => {
      ...
      getList() {
        this.axios.get('specification/infoSpecification', {
          params: {
            id: this.goods_id
          }
        }).then((response) => {
