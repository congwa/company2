...
-- ----------------------------
BEGIN;
INSERT INTO `nideshop_footprint` VALUES (1, 1, 1181046, 1556527710);
INSERT INTO `nideshop_footprint` VALUES (2, 1, 1181096, 1556527739);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品对应规格表值表';

-- ----------------------------
-- Records of nideshop_goods_specification
-- ----------------------------
BEGIN;
INSERT INTO `nideshop_goods_specification` VALUES (11, 1181067, 2, '1ml', '');
INSERT INTO `nideshop_goods_specification` VALUES (12, 1181067, 2, '1ml×5', '');
INSERT INTO `nideshop_goods_specification` VALUES (13, 1181067, 2, '1ml×100', '');
INSERT INTO `nideshop_goods_specification` VALUES (14, 1181015, 2, '50ml', '');
INSERT INTO `nideshop_goods_specification` VALUES (15, 1181015, 2, '50ml×2', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `nideshop_product` VALUES (272, 1181067, '11', '11_1181067', 999, 120.00);
INSERT INTO `nideshop_product` VALUES (273, 1181067, '12', '12_1181067', 999, 500.00);
INSERT INTO `nideshop_product` VALUES (274, 1181067, '13', '13_1181067', 999, 9000.00);
INSERT INTO `nideshop_product` VALUES (275, 1181015, '14', '14_1181015', 999, 360.00);
INSERT INTO `nideshop_product` VALUES (276, 1181015, '15', '15_1181015', 999, 580.00);
COMMIT;
...
CREATE TABLE `nideshop_user` (
  ...
  `nickname` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `nideshop_user` VALUES (2, '微信用户6e32da76-9907-4990-bbd9-d785b852d98f', '', 2, 0, 1556527524, 1556527524, '::ffff:127.0.0.1', 0, '丁香枝上', '', '::ffff:127.0.0.1', 'https://wx.qlogo.cn/mmopen/vi_32/cCrY5haSNBTdxE1cErJqJr8ngbcHbzx2AasjwDvhmjicCIu6mUVp9S3ksoGajkhJZ8Eyibur5f8icm9uZqLPQnfbQ/132', 'oKl3s0O7pKOe69yCBnGR_QCR4yDk');
INSERT INTO `nideshop_user` VALUES (3, '微信用户a0f7014e-ea0c-4376-a154-11b565c1d41d', '', 1, 0, 1556528007, 1556528051, '::ffff:127.0.0.1', 0, '王聪', '', '::ffff:127.0.0.1', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTKOygVbelgzqLBGRTp5tpxx0V9V4Q6bpQ751mnsGaSLJYkBR80Iic6te4eUQjAic1Wa779MWaqvWHuA/132', 'oKl3s0IOvPhfZFsNsPhP4YdktwnI');
COMMIT;
