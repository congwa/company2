...
module.exports = class extends think.Controller {
  ...
  indexAction() {
    ...
    return _asyncToGenerator(function* () {
      const attribute = yield _this.model('attribute_category').where().select();
      return _this.success(attribute);
    })();
  }
  ...
  addAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      const model = _this2.model('attribute_category');
  ...
  infoAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      const model = _this3.model('attribute_category');
  ...
  deleteAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this4.model('attribute_category').where({ id: id }).limit(1).delete();
...
//# sourceMappingURL=attribute_category.js.map