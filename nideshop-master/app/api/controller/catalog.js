...
module.exports = class extends Base {
  ...
  indexAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      const data = yield model.limit(10).where({ parent_id: 0, is_show: 1 }).select();
      ...
      if (currentCategory && currentCategory.id) {
        currentCategory.subCategoryList = yield model.where({ 'parent_id': currentCategory.id, is_show: 1 }).select();
      }
